...
class Ui_FenKey(object):
    ...
    def retranslateUi(self, FenKey):
        ...
        self.comboAlgo.setItemText(0, _translate("FenKey", "Serpent-256"))
        self.comboAlgo.setItemText(1, _translate("FenKey", "AES-256"))
        self.comboAlgo.setItemText(2, _translate("FenKey", "Twofish-256"))
